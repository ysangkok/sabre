...
* inline bool SafeEquals( const T t, const U u )
* inline bool SafeNotEquals( const T t, const U u )
* inline bool SafeGreaterThan( const T t, const U u )
* inline bool SafeGreaterThanEquals( const T t, const U u )
* inline bool SafeLessThan( const T t, const U u )
* inline bool SafeLessThanEquals( const T t, const U u )
* inline bool SafeModulus( const T& t, const U& u, T& result )
* inline bool SafeMultiply( T t, U u, T& result )
* inline bool SafeDivide( T t, U u, T& result )
* inline bool SafeAdd( T t, U u, T& result )
* inline bool SafeSubtract( T t, U u, T& result )
*
*/
...
{
    public:
        static __attribute__((noreturn)) void BehaviorWarning()
        {
...
{
public:
    static bool IsEquals( const T t, const U u ) { return ( t == u ); }
};

template < typename T, typename U > class EqualityTest< T, U, ComparisonMethod_CastInt >
{
public:
    static bool IsEquals( const T t, const U u ) { return ( (int)t == (int)u ); }
};

template < typename T, typename U > class EqualityTest< T, U, ComparisonMethod_CastInt64 >
{
public:
    static bool IsEquals( const T t, const U u ) { return ( (__int64)t == (__int64)u ); }
};
...
{
public:
    static bool GreaterThan( const T t, const U u ) { return ( t > u ); }
};

template < typename T, typename U > class GreaterThanTest< T, U, ComparisonMethod_CastInt >
{
public:
    static bool GreaterThan( const T t, const U u ) { return ( (int)t > (int)u ); }
};

template < typename T, typename U > class GreaterThanTest< T, U, ComparisonMethod_CastInt64 >
{
public:
    static bool GreaterThan( const T t, const U u ) { return ( (__int64)t > (__int64)u ); }
};
...
public:
    ...
    static bool Multiply( const T& t, const U& u, T& ret )
    {
        int tmp = t * u;
...
{
public:
    static bool RegMultiply( const unsigned __int64& a, const unsigned __int64& b, unsigned __int64* pRet )
    {
#if SAFEINT_USE_INTRINSICS
...
{
public:
    static bool RegMultiply( const unsigned __int64& a, unsigned __int32 b, unsigned __int64* pRet )
    {
#if SAFEINT_USE_INTRINSICS
...
public:
    ...
    static bool RegMultiply( const unsigned __int64& a, signed __int32 b, unsigned __int64* pRet )
    {
        if( b < 0 && a != 0 )
            return false;
...
{
public:
    static bool RegMultiply( const unsigned __int64& a, signed __int64 b, unsigned __int64* pRet )
    {
        if( b < 0 && a != 0 )
            return false;
...
public:
    ...
    static bool RegMultiply( signed __int32 a, const unsigned __int64& b, signed __int32* pRet )
    {
...
public:
    ...
    static bool RegMultiply( unsigned __int32 a, const unsigned __int64& b, unsigned __int32* pRet )
    {
        // Consider that a*b can be broken up into:
        // (bHigh * 2^32 + bLow) * a
        // => (bHigh * a * 2^32) + (bLow * a)
...
{
public:
    static bool RegMultiply( unsigned __int32 a, const signed __int64& b, unsigned __int32* pRet )
    {
        if( b < 0 && a != 0 )
            return false;
...
{
public:
    static bool RegMultiply( const signed __int64& a, const signed __int64& b, signed __int64* pRet )
    {
#if SAFEINT_USE_INTRINSICS
...
{
public:
    static bool RegMultiply( const signed __int64& a, unsigned __int32 b, signed __int64* pRet )
    {
#if SAFEINT_USE_INTRINSICS
...
{
public:
    static bool RegMultiply( const signed __int64& a, signed __int32 b, signed __int64* pRet )
    {
#if SAFEINT_USE_INTRINSICS
        return IntrinsicMultiplyInt64( a, (signed __int64)b, pRet );
#else
...
{
public:
    static bool RegMultiply( signed __int32 a, const signed __int64& b, signed __int32* pRet )
    {
#if SAFEINT_USE_INTRINSICS
        __int64 tmp;
...
public:
    ...
    static bool RegMultiply( const signed __int64& a, const unsigned __int64& b, signed __int64* pRet )
    {
        bool aNegative = false;
...
public:
    ...
    static bool Multiply( const T& t, U u, T& ret )
    {
        C_ASSERT( IntTraits<T>::isInt64 );
        __int64          t1 = t;
...
public:
    ...
    // U is unsigned __int64
    static bool Multiply(T t, const U& u, T& ret)
    {
        C_ASSERT( IntTraits<U>::isUint64 );
        unsigned __int64 u1 = u;
        __int32 tmp;
...
{
public:
    static bool Addition( const T& lhs, const U& rhs, T& result )
    {
...
{
public:
    static bool Addition( const __int64& lhs, const unsigned __int64& rhs, __int64& result )
    {
        C_ASSERT( IntTraits< T >::isInt64 && IntTraits< U >::isUint64 );
...
{
public:
    static bool Subtract( const T& lhs, const U& rhs, T& result )
    {
...
{
public:
    static bool Subtract( const T& lhs, const U& rhs, U& result )
    {
        // both are unsigned - easy case
...
{
public:
    static bool Subtract( const U& lhs, const T& rhs, T& result )
    {
        // both values are 16-bit or less
        // rhs is signed, so could end up increasing or decreasing
        __int32 tmp = lhs - rhs;
...
{
public:
    static bool Subtract( const __int64& lhs, const unsigned __int64& rhs, __int64& result )
    {
        C_ASSERT( IntTraits< T >::isInt64 && IntTraits< U >::isUint64 );
...
public:
    ...
    static bool Subtract( const __int64& lhs, const unsigned __int64& rhs, T& result )
    {
        C_ASSERT( IntTraits< T >::isUint64 && IntTraits< U >::isInt64 );
...
public:
    ...
    const T& Ref() const { return m_int; }
    ...
    const SafeInt< T, E >& operator +() const { return *this; }
    ...
    SafeInt< T, E > operator ~() const { return SafeInt< T, E >( (T)~m_int ); }
    ...
    bool operator <( SafeInt< T, E > rhs ) const
    {
        return m_int < (T)rhs;
    }
    ...
    bool operator ==( SafeInt< T, E > rhs ) const { return m_int == (T)rhs; }
    ...
    SafeInt< T, E > Min( SafeInt< T, E > test, const T floor = IntTraits< T >::minInt ) const
    {
        T tmp = test < m_int ? (T)test : m_int;
        return tmp < floor ? floor : tmp;
    }

    SafeInt< T, E > Max( SafeInt< T, E > test, const T upper = IntTraits< T >::maxInt ) const
    {
        T tmp = test > m_int ? (T)test : m_int;
...
template < typename T, typename U, typename E >
bool operator <( SafeInt< U, E > lhs, SafeInt< T, E > rhs )
{
...
template < typename T, typename U, typename E >
bool operator >( SafeInt< T, E > lhs, SafeInt< U, E > rhs )
{
